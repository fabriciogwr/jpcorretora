...
public class CategoriaReceitaController {
	...
	public List<Categoria> getCatData() {
		...
		List<Categoria> allCat = catRepo.findByTipo(TipoMovimento.RECEITA.getCod());
		return allCat;
	}
    ...
    @FXML
    void novaCategoriaReceita() {
    	Categoria cat = new Categoria(null, TipoMovimento.RECEITA, null, null);
